...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 20 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch20Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch20Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 20 Intensity", true, 46)]
        ...
        protected LimitlessGlitch20 _limitlessGlitch20;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch20);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch20.strength.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch20.strength;
        }
        ...
        public virtual void OnMMLimitlessGlitch20ShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch20.strength.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch20ShakeEvent.Register(OnMMLimitlessGlitch20ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch20ShakeEvent.Unregister(OnMMLimitlessGlitch20ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch20ShakeEvent
    {
