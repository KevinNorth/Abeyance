...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 4 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch4Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch4Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 4 Intensity", true, 46)]
        ...
        protected LimitlessGlitch4 _limitlessGlitch4;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch4);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch4.amount.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch4.amount;
        }
        ...
        public virtual void OnMMLimitlessGlitch4ShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch4.amount.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch4ShakeEvent.Register(OnMMLimitlessGlitch4ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch4ShakeEvent.Unregister(OnMMLimitlessGlitch4ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch4ShakeEvent
    {
