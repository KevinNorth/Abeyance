...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 13 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch13Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch13Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 13 Intensity", true, 46)]
        /// whether or not to add to the fade value
        [Tooltip("whether or not to add to the fade value")]
        ...
        protected LimitlessGlitch13 _limitlessGlitch13;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch13);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch13.fade.Override(newValue);
        }
        ...
        {
            _initialFade = _limitlessGlitch13.fade;
        }
        ...
        public virtual void OnMMLimitlessGlitch13ShakeEvent(AnimationCurve fade, float duration, float remapMin, float remapMax, bool relativeFade = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch13.fade.Override(_initialFade);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch13ShakeEvent.Register(OnMMLimitlessGlitch13ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch13ShakeEvent.Unregister(OnMMLimitlessGlitch13ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch13ShakeEvent
    {
