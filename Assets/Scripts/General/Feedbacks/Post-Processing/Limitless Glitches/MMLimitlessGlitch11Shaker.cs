...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 11 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch11Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch11Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 11 Intensity", true, 46)]
        ...
        protected LimitlessGlitch11 _limitlessGlitch11;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch11);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch11.amount.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch11.amount;
        }
        ...
        public virtual void OnMMLimitlessGlitch11ShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch11.amount.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch11ShakeEvent.Register(OnMMLimitlessGlitch11ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch11ShakeEvent.Unregister(OnMMLimitlessGlitch11ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch11ShakeEvent
    {
