...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 1 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch5Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch5Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 5 Intensity", true, 46)]
        ...
        protected LimitlessGlitch5 _limitlessGlitch5;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch5);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch5.amount.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch5.amount;
        }
        ...
        public virtual void OnMMLimitlessGlitch5ShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch5.amount.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch5ShakeEvent.Register(OnMMLimitlessGlitch5ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch5ShakeEvent.Unregister(OnMMLimitlessGlitch5ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch5ShakeEvent
    {
