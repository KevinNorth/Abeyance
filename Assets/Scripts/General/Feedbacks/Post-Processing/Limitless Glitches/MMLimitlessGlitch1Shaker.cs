...
namespace KitTraden.Abeyance.TopDownEngine.Feedbacks
{
...
#endif
    public class MMLimitlessGlitch1Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 1 Intensity", true, 46)]
        ...
        protected Limitless_Glitch1 _limitlessGlitch1;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch1);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch1.amount.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch1.amount;
        }
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch1.amount.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch1ShakeEvent.Register(OnMMLimitlessGlitch1ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch1ShakeEvent.Unregister(OnMMLimitlessGlitch1ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch1ShakeEvent
    {
