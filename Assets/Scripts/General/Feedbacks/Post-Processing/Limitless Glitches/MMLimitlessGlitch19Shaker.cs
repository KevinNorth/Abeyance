...
namespace KitTraden.Abeyance.TopDownEngine.Feedbacks
{
    ...
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch19Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch19Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 19 Fade", true, 46)]
        ...
        protected LimitlessGlitch19 _limitlessGlitch19;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch19);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch19.fade.Override(newValue);
        }
        ...
        {
            _initialFade = _limitlessGlitch19.fade;
        }
        ...
        public virtual void OnMMLimitlessGlitch19ShakeEvent(AnimationCurve fade, float duration, float remapMin, float remapMax, bool relativeFade = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch19.fade.Override(_initialFade);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch19ShakeEvent.Register(OnMMLimitlessGlitch19ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch19ShakeEvent.Unregister(OnMMLimitlessGlitch19ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch19ShakeEvent
    {
