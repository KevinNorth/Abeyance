...
{
    /// <summary>
    /// Add this class to a Camera with a Limitless Glitch 17 post processing and it'll be able to "shake" its values by getting events
    /// </summary>
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/Limitless Glitch/MMLimitlessGlitch17Shaker")]
#if MM_POSTPROCESSING
	[RequireComponent(typeof(PostProcessVolume))]
#endif
    public class MMLimitlessGlitch17Shaker : MMShaker
    {
        [MMInspectorGroup("Limitless Glitch 17 Intensity", true, 46)]
        ...
        protected LimitlessGlitch17 _limitlessGlitch17;
        ...
        protected override void Initialization()
        {
            ...
            _volume.profile.TryGetSettings(out _limitlessGlitch17);
        }
        ...
        protected override void Shake()
        {
            ...
            _limitlessGlitch17.strength.Override(newValue);
        }
        ...
        {
            _initialIntensity = _limitlessGlitch17.strength;
        }
        ...
        public virtual void OnMMLimitlessGlitch17ShakeEvent(AnimationCurve intensity, float duration, float remapMin, float remapMax, bool relativeIntensity = false,
        ...
        protected override void ResetTargetValues()
        {
            ...
            _limitlessGlitch17.strength.Override(_initialIntensity);
        }
        ...
        {
            base.StartListening();
            MMLimitlessGlitch17ShakeEvent.Register(OnMMLimitlessGlitch17ShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMLimitlessGlitch17ShakeEvent.Unregister(OnMMLimitlessGlitch17ShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMLimitlessGlitch17ShakeEvent
    {
