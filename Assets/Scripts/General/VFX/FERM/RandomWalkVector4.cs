...
{
    public class RandomWalkVector4
    {
        ...
        public Vector4 value
        {
            get
            {
                return new Vector4(xWalk.value, yWalk.value, zWalk.value, wWalk.value);
            }
            set
            {
                xWalk.value = value.x;
        ...
        public RandomWalkVector4 Clone()
        {
            return new RandomWalkVector4(
                value,
                speed,
                maxSpeedDelta,
                minValue,
        ...
        public Vector4 Update(float deltaTime)
        {
            return new Vector4(
